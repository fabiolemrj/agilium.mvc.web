    ...
    $('#btnAjuda').click(function () {
        ...
        Tour.run([
            ...
            },
            {
                ...
                content: '<strong><div align="center" class="text-info">Empresa</div></strong><p><div align="center">campo para seleção da empresa relacionado a conta a pagar.</div></p>',
                position: 'top'
            },
            {
                element: $('#labelFornec'),
                content: '<strong><div align="center" class="text-info">Fornecedor</div></strong><p><div align="center">campo para seleção do fornecedor relacionado a conta a pagar.</div></p>',
                position: 'top'
            },

            {
                element: $('#labelCategFinanc'),
            ...
            {
                element: $('#labelConta'),
                content: '<strong><div align="center" class="text-info">Conta</div></strong><p><div align="center">campo para seleção da conta (plano de contas) relacionado a conta a pagar.</div></p>',
                position: 'top'
            },
            {
                element: $('#labelDesc'),
                content: '<strong><div align="center" class="text-info">Descrição</div></strong><p><div align="center">Campo Descrição da conta a pagar.</div></p>',
            },
            {
                element: $('#labelParcelaIni'),
                content: '<strong><div align="center" class="text-info">Parcela</div></strong><p><div align="center">Campo referente a parcela da conta a pagar.</div></p>',
            },
            {
                element: $('#labelDtVenc'),
                content: '<strong><div align="center" class="text-info">Data Vencimento</div></strong><p><div align="center">Campo referente a data de vencimento da conta a pagar.</div></p>',
            },
            {
