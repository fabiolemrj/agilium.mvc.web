...
$(function () {
    $('#btnAjuda').click(function () {
        ...
        Tour.run([
            ...
            {
                element: $('#areaFiltro'),
                content: '<strong><div align="center" class="text-info">Produto</div></strong><p><div align="center">Nome do Produto a que se refere o preço.</div></p>',
                position: 'left'
            },
            {
                element: $('#search-btn'),
            ...
            },
            {
                ...
                content: '<strong><div align="center" class="text-info">Cliente</div></strong><p><div align="center">Campo para indicação do cliente a que o preço se refere.</div></p>',
                position: 'top'
            },
            {
